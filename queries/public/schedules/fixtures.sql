SELECT sf.id as fixture_id, sf."scheduleGroupId" as match_id, home.title as home, away.title as away FROM sprocket.schedule_fixture sf
...
ORDER BY sg.start, sg.end, fixture_id